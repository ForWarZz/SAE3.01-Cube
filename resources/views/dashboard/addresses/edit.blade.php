<x-app-layout>
                ...
                <div class="p-6">
                    ...
                    <form method="POST" action="{{ route("dashboard.addresses.update", $address) }}" id="address-form">
                        ...
                        <x-form-input
                            ...
                            :value="old('nom_adresse', $address->nom_adresse)"
                            required
                        />
                        ...
                        <x-form-input
                            ...
                            :value="old('complement_adresse', trim($address->complement_adresse))"
                        />
                        ...
                        <x-form-input
                            ...
                            required
                            :value="old('code_postal', trim($address->city->cp_ville))"
                            maxlength="5"
                        />
    ...
    <script>
        const initialCp = '{{ old("code_postal", trim($address->city->cp_ville)) }}';
        const initialCity = '{{ old("nom_ville", trim($address->city->nom_ville)) }}';
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            if (initialCp.length >= 5) {
                loadCities(initialCp, initialCity);
            }
        });
    </script>
</x-app-layout>
