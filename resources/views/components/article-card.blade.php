    ...
    <a href="{{ route("articles.show", $article->id_article) }}" class="block">
        <div class="relative h-56 overflow-hidden bg-gray-50">
            ...
            @if ($article->bike?->isNew())
                <span class="absolute top-3 right-3 z-10 flex items-center gap-1 rounded-full bg-gradient-to-r from-lime-400 to-green-500 px-3 py-1 text-xs font-bold uppercase tracking-wide text-gray-900 shadow-lg">
