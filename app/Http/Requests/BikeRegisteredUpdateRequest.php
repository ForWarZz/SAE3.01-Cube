...
class BikeRegisteredUpdateRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'num_serie_velo_enr' => ['nullable', 'string', 'max:100', 'unique:velo_enregistre,num_serie_velo_enr,'.$this->route('bikeRegistered')->id_velo_enr.',id_velo_enr'],
            'date_achat_velo_enr' => ['nullable', 'date', 'before_or_equal:today'],
            'millesime_velo_enr' => ['nullable', 'string', 'max:4'],
            'facture' => ['nullable', 'file', 'mimes:pdf', 'max:2048'],
        ];
    }
